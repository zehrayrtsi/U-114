...
- **Daily Scrum**: Daily Scrum toplantılarının zamansal sebeplerden ötürü Discord ve Whatsapp programları üzerinden yapılmasına karar verilmiştir. Daily Scrum toplantısı örneği pdf olarak tarafımızdan paylaşılmaktadır: [Sprint 1 Daily Scrum Chats](https://drive.google.com/file/d/1x1EDJDZGMr75BrfVw479L9FCZrpWoxAR/view?usp=sharing)
...
- **Daily Scrum**: Daily Scrum toplantılarının zamansal sebeplerden ötürü Discord ve Whatsapp programları üzerinden yapılmasına karar verilmiştir. Daily Scrum toplantısı örneği pdf olarak tarafımızdan paylaşılmaktadır: [Sprint 2 Daily Scrum Chats](https://drive.google.com/file/d/1_tcEGSEocHF-J1_zxY36851Co9Hxa6V_/view?usp=sharing).
...
Sprint Review:
-Karakterler ve oyun için hikayeler kesinleştirildi.
-Oyun içi mapler düzenlendi ve implemente edildi.
-Oyun için intro hazırlandı.
...
-Proje süresince gösterilen katılım ve akış değerlendirilmiştir.
---
